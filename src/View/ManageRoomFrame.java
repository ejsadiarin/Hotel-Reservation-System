...
public class ManageRoomFrame extends javax.swing.JFrame {
  ...
  private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
    ...
    boolean isModified = controller.datePriceModifier(hotelName, roomName, Integer.parseInt(dayInput),
        Integer.parseInt(modifierInput));
    if (isModified)
      rehydrateFrame(view, controller, hotelName, roomName);
  ...
  /**
   * Rehydrates the current frame with latest information
   */
